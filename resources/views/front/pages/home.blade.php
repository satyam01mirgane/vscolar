        ...
        <div class="container-fullscreen">
            <div class="text-left">
                <div class="text-light">
                    ...
                    <a href="{{ url('about-us') }}" class="btn btn-red">Know More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <section id="image-block" class="image-block no-padding">
            <div class="container-fluid">
                <div class="row">
					...
					<iframe style=" border-radius: 25px;" width="560" height="450" src="{{app_setting()->about_videourl}}" title="YouTube video player" frameborder="0" 
allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>		
                    ...
                    <div class="col-lg-6">
                        <div class="heading-text heading-section">
                            ...
                            <span class="lead">{{app_setting()->site_description}}
                            </span>
                        </div>
                        <a href="{{url('workshops')}}" class="btn btn-outline btn-dark"><span>START EXPLORING!</span></a>
                    </div>
                </div>
            </div>
        </section>
		...
		@include('front.home-page-common.home-workshop')
		
		@include('front.home-page-common.home-course')
		
		 <!-- Parallax -->
        <section class="p-t-200 p-b-200" data-bg-video="{{asset('assets/video/lightbulb.mp4')}}">
        ...
        <!-- end: Revolution Slider-->
		 ...
		 <!-- BLOG -->
        @include('front.home-page-common.home-blog')
		<section id="section3" class="p-t-100 p-b-100" data-bg-parallax="{{asset('assets/images/banner1.jpg')}}"><div class="parallax-container scrolly-invisible img-loaded" data-bg="{{asset('assets/images/banner1.jpg')}}" data-velocity="-.140" style="background: url({{asset('assets/images/banner1.jpg')}}) 0px;" data-ll-status="loaded"></div><div class="parallax-container scrolly-invisible img-loaded" data-bg="{{asset('assets/images/top-courses-banner1.jpg')}}" data-velocity="-.140" style="background: url({{asset('assets/images/banner1.jpg')}}) 0px;" data-ll-status="loaded"></div>
            <div class="container xs-text-center sm-text-center text-light">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="text-center">
                            <div class="counter text-lg"> <span data-speed="4500" data-refresh-interval="23" data-to="365" data-from="100" data-seperator="true">{{app_setting()->total_enrollments}}</span> </div>
                            <div class="seperator seperator-small"></div>
            ...
            <div class="container">
                <div class="row">
				 <div class="heading-text heading-section">
                    ...
                    <div class="col-lg-5">
                        <img alt="real-estate" src="{{asset('assets/images/skill.jpg')}}" class="img-fluid m-b-10">
                    </div>
                    <div class="col-lg-7">
						...
						<div class="clear"></div>
                        <a class="read-more" href="{{url('services')}}">Check Out Wings <i class="fa fa-arrow-right"></i></a>
					</div>
					</div>
		...
		<section id="section3"style="padding-top:5px !important;padding-bottom:10px !important";>
            <div class="container">
				...
				<div class="col-lg-7">
						...
						<div class="clear"></div>
                        <a class="read-more" href="{{url('workshops')}}">Enhance network<i class="fa fa-arrow-right"></i></a>
                    </div>
					<div class="col-lg-5">
                        <img alt="real-estate" src="{{asset('assets/images/Networking-opportunity.jpg')}}" class="img-fluid m-b-10">
                    </div>
                </div>
		...
		<section id="section3" style="padding-top:5px !important;padding-bottom:10px !important";>
            <div class="container">
                <div class="row">
				<div class="col-lg-5">
                        <img alt="real-estate" src="{{asset('assets/images/community-building.jpg')}}" class="img-fluid m-b-10">
                    </div>
				<div class="col-lg-7">
						<!--<h3>Tests</h3>-->
						...
						<div class="clear"></div>
                        <a class="read-more" href="{{url('courses')}}">Explore Courses<i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
         ...
         <div id="modalShop" class="modal modal-auto-open no-padding" data-delay="3000" style="max-width: 700px;">
            <div class="row">
                ...
                <a href= "https:// VIEF SCHOLAR .in/events" class="col-md-6 d-none d-sm-block no-padding" style="background: transparent url({{asset('assets/images/award.png')}}) no-repeat scroll center top / cover; height:470px;">
                   </a>
