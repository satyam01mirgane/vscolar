                            ...
                            <div class="post-item border">
                                <div class="post-item-wrap">
                                    <div class="post-image">
                                        <a href="{{url('start-quiz/'.$v->slug)}}">
                                            <img alt="" src="{{asset($v->image)}}"></a>
                                    </div>
                                    <div class="post-item-description">                                
										<h2><a href="{{url('start-quiz/'.$v->slug)}}">{{truncate($v->name,30)}}</a></h2>
										<p>{{truncate($v->description,40)}}</p>
           
											<h2>
												<a href="{{url('start-quiz/'.$v->slug)}}"><button class="btn btn-outline" type="button">Start Quiz</button></a>
											</h2>
