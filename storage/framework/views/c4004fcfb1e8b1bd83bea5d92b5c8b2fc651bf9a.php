<div class='form-group form-datepicker <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>'
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <div class="input-group">
            ...
            <input type='text' title="<?php echo e($form['label']); ?>" readonly
                   <?php echo e($required); ?> <?php echo e($readonly); ?> <?php echo $placeholder; ?> <?php echo e($disabled); ?> class='form-control notfocus input_date' name="<?php echo e($name); ?>" id="<?php echo e($name); ?>"
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/date/component.blade.php ENDPATH**/ ?>