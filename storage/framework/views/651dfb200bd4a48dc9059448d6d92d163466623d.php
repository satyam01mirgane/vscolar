...
<section id="section3">
            <div class="container">
                <div class="row">
				<form method="POST" action="<?php echo e(url('/submit-test')); ?>">
...
</script><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/pages/start-test.blade.php ENDPATH**/ ?>