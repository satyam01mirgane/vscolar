<!-- <section id="page-content" style="background-color: #fffff; padding: 50px 0;">
        ...
        <div class="row" style="justify-content: center;">
            <div class="content col-lg-12">
                ...
                <div class="workshop-carousel" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 30px;">
                    ...
                    <div class="workshop-item" style="background-color: #fff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); overflow: hidden; width: calc(33.333% - 20px); margin-bottom: 30px; transition: transform 0.3s ease, box-shadow 0.3s ease; animation: fadeInUp 0.8s ease-out <?php echo e($k * 0.1 + 0.4); ?>s both;">
                        <div class="workshop-item-wrap" style="height: 100%; display: flex; flex-direction: column;">
                            <div class="workshop-image" style="height: 200px; overflow: hidden;">
                                <a href="<?php echo e(url('workshops-detail/'.$v->slug)); ?>" style="display: block; height: 100%;">
                                    <img alt="<?php echo e($v->name); ?>" src="<?php echo e(asset($v->image)); ?>" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease;">
                                </a>
                            </div>
                            <div class="workshop-item-description" style="padding: 20px; flex-grow: 1; display: flex; flex-direction: column;">
                                <span class="workshop-meta-date" style="display: block; color: #888; font-size: 14px; margin-bottom: 10px;">
                                    <i class="fa fa-calendar-o" style="margin-right: 5px;"></i><?php echo e(date('d M Y h:i A', strtotime($v->session_date.' '.$v->session_time))); ?>

                                </span>
                                <h3 style="font-size: 20px; margin-bottom: 10px;">
                                    <a href="<?php echo e(url('workshops-detail/'.$v->slug)); ?>" style="color: #333; text-decoration: none; transition: color 0.3s ease;">
                                        <?php echo e(truncate($v->name, 30)); ?>

                                    </a>
                                </h3>
                                <p style="color: #666; font-size: 14px; margin-bottom: 15px; flex-grow: 1;"><?php echo e(truncate($v->short_description, 70)); ?></p>
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <?php if(!in_array($v->id, cartproduct())): ?>
                                        <form action="<?php echo e(route('cart.store')); ?>" method="POST" enctype="multipart/form-data" style="display: flex; gap: 10px;">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <?php if($v->total_seat > 0): ?>
                                                ...
                                                <span class="seats-left" style="background-color: #f0f0f0; color: #333; padding: 8px 15px; border-radius: 5px; font-size: 14px;"><?php echo e($v->total_seat); ?> Seats Left</span>
                                            <?php else: ?>
 ...
 -->
<?php /**PATH D:\New folder\htdocs\RUN\resources\views/front/home-page-common/home-workshop.blade.php ENDPATH**/ ?>