...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        <?php if(file_exists($file_location)): ?>
            ...
            <?php if($containTR): ?>
                <?php echo $__env->make('crudbooster::default.type_components.'.$type.'.component_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
                <tr>
                    <td><?php echo e($form['label']); ?></td>
                    <td><?php echo $__env->make('crudbooster::default.type_components.'.$type.'.component_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></td>
                </tr>
            <?php endif; ?>
        <?php elseif(file_exists($user_location)): ?>
            <?php $containTR = (substr(trim(file_get_contents($user_location)), 0, 4) == '<tr>') ? TRUE : FALSE;?>
            <?php if($containTR): ?>
                <?php echo $__env->make('vendor.crudbooster.type_components.'.$type.'.component_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
                <tr>
                    <td><?php echo e($form['label']); ?></td>
                    <td><?php echo $__env->make('vendor.crudbooster.type_components.'.$type.'.component_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></td>
                </tr>
            <?php endif; ?>
        <?php else: ?>
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/form_detail.blade.php ENDPATH**/ ?>