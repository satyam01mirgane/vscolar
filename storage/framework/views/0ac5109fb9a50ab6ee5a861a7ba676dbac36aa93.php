...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(($page_title)?get_setting('appname').': '.strip_tags($page_title):"Admin Area"); ?></title>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>"/>
    <meta name='generator' content='CRUDBooster <?php echo e(\crocodicstudio\crudbooster\commands\CrudboosterVersionCommand::$version); ?>'/>
...
<body class="<?php echo (Session::get('theme_color'))?:'skin-blue'; echo ' '; echo config('crudbooster.ADMIN_LAYOUT'); ?> <?php echo e(($sidebar_mode)?:''); ?>">
<div id='app' class="wrapper">

    <!-- Header -->
<?php echo $__env->make('crudbooster::header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<!-- Sidebar -->
<?php echo $__env->make('crudbooster::sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            ...
            <?php if($module): ?>
                <h1>
                    ...
                    <i class='<?php echo ($page_icon)?:$module->icon; ?>'></i> <?php echo ucwords(($page_title)?:$module->name); ?> &nbsp;&nbsp;
                    ...
                    <?php if(CRUDBooster::getCurrentMethod() == 'getIndex'): ?>
                        <?php if($button_show): ?>
                            <a href="<?php echo e(CRUDBooster::mainpath().'?'.http_build_query(Request::all())); ?>" id='btn_show_data' class="btn btn-sm btn-primary"
                               title="<?php echo e(cbLang('action_show_data')); ?>">
                                <i class="fa fa-table"></i> <?php echo e(cbLang('action_show_data')); ?>
                        ...
                        <?php if($button_add && CRUDBooster::isCreate()): ?>
                            <a href="<?php echo e(CRUDBooster::mainpath('add').'?return_url='.urlencode(Request::fullUrl()).'&parent_id='.g('parent_id').'&parent_field='.$parent_field); ?>"
                               id='btn_add_new_data' class="btn btn-sm btn-success" title="<?php echo e(cbLang('action_add_data')); ?>">
                                <i class="fa fa-plus-circle"></i> <?php echo e(cbLang('action_add_data')); ?>
                    ...
                    <?php if($button_export && CRUDBooster::getCurrentMethod() == 'getIndex'): ?>
                        <a href="javascript:void(0)" id='btn_export_data' data-url-parameter='<?php echo e($build_query); ?>' title='Export Data'
                           class="btn btn-sm btn-primary btn-export-data">
                            <i class="fa fa-upload"></i> <?php echo e(cbLang("button_export")); ?>
                    ...
                    <?php if($button_import && CRUDBooster::getCurrentMethod() == 'getIndex'): ?>
                        <a href="<?php echo e(CRUDBooster::mainpath('import-data')); ?>" id='btn_import_data' data-url-parameter='<?php echo e($build_query); ?>' title='Import Data'
                           class="btn btn-sm btn-primary btn-import-data">
                            <i class="fa fa-download"></i> <?php echo e(cbLang("button_import")); ?>
                ...
                <ol class="breadcrumb">
                    <li><a href="<?php echo e(CRUDBooster::adminPath()); ?>"><i class="fa fa-dashboard"></i> <?php echo e(cbLang('home')); ?></a></li>
                    <li class="active"><?php echo e($module->name); ?></li>
                </ol>
            <?php else: ?>
                <h1><?php echo e(Session::get('appname')); ?>

                    <small> <?php echo e(cbLang('text_dashboard')); ?> </small>
                </h1>
            <?php endif; ?>
        </section>
        ...
        <section id='content_section' class="content">
            ...
            <?php if(Session::get('message')!=''): ?>
                <div class='alert alert-<?php echo e(Session::get("message_type")); ?>'>
                    ...
                    <h4><i class="icon fa fa-info"></i> <?php echo e(cbLang("alert_".Session::get("message_type"))); ?></h4>
    ...
    <!-- Footer -->
    <?php echo $__env->make('crudbooster::footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

</div><!-- ./wrapper -->


<?php echo $__env->make('crudbooster::admin_template_plugins', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/admin_template.blade.php ENDPATH**/ ?>