 <div id="topbar" class="topbar-transparent dark home-corporate.html submenu-light ">
                ...
                <div class="container">
                    ...
                    <div class="header-extras">
                        <ul>
                            ...
                            <li id="shopping-cart">
                            <a href="<?php echo e(url('cart')); ?>" style="display: inline-flex;"> <i class="fa fa-shopping-cart" aria-hidden="true"></i>
        ...
        <!-- end: Header --><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/common/navbar.blade.php ENDPATH**/ ?>