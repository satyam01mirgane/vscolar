                            ...
                            <div class="post-item border">
                                <div class="post-item-wrap">
                                    <div class="post-image">
                                        <a href="<?php echo e(url('start-test/'.$v->slug)); ?>">
                                            <img alt="" src="<?php echo e(asset($v->image)); ?>"></a>
                                    </div>
                                    <div class="post-item-description">                                
										<h2><a href="<?php echo e(url('start-test/'.$v->slug)); ?>"><?php echo e(truncate($v->name,30)); ?></a></h2>
										<p><?php echo e(truncate($v->description,40)); ?></p>
           
											<h2>
												<a href="<?php echo e(url('start-test/'.$v->slug)); ?>"><button class="btn btn-outline" type="button">Start Test</button></a>
											</h2>
...
</script><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/pages/test-list.blade.php ENDPATH**/ ?>