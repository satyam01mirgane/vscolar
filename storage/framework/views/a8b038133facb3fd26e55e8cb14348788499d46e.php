                ...
                <script>
                    $(function () {
                        $('#<?php echo e($name); ?>').select2({
                            placeholder: {
                                id: '-1',
                                text: '<?php echo e(cbLang('text_prefix_option')); ?> <?php echo e($form['label']); ?>'
                            },
                            allowClear: true,
                            ajax: {
                                url: '<?php echo $url; ?>',
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <select style='width:100%' class='form-control' id="<?php echo e($name); ?>"
            ...
            <?php if($form['dataenum']): ?>
                <option value=''><?php echo e(cbLang('text_prefix_option')); ?> <?php echo e($form['label']); ?></option>
                <?php
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/select2/component.blade.php ENDPATH**/ ?>