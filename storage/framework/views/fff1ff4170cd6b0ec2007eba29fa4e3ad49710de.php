<div class='form-group <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>' style="<?php echo e(@$form['style']); ?>">
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <input type='password' title="<?php echo e($form['label']); ?>" id="<?php echo e($name); ?>"
               <?php echo e($required); ?> <?php echo $placeholder; ?> <?php echo e($readonly); ?> <?php echo e($disabled); ?> <?php echo e($validation['max']?"maxlength=".$validation['max']:""); ?> class='form-control'
...
</div><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/password/component.blade.php ENDPATH**/ ?>