...
<!-- SECTION IMAGE FULLSCREEN -->
        <section class="fullscreen" class="slide" data-bg-video="<?php echo e(asset('assets/video/Blue-Modern-Dinosaur-Park-Video.mp4')); ?>">
		  <div class="bg-overlay"></div>
            <div class="container">
                <div class="container-fullscreen">
                    <div class="text-left">
                        <div class="text-light" style="">
                            <!--<h4 class="text-uppercase m-b-0">We Care</h4>-->
                            <h3 class="text-uppercase text-lg"><span style="color: #12254A !important;">LEARN BY</span> PLAYING, <br><span style="color: #12254A !important;">PLAY BY</span> LEARNING</h3>
...
$('#comment').on('click', function(e) {
   ...
   <?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/pages/home.blade.php ENDPATH**/ ?>