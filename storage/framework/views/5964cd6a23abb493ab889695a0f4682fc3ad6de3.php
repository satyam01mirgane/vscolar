...
<div class='form-group' id='form-group-<?php echo e($name); ?>' style="<?php echo e(@$form['style']); ?>">
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <textarea id='textarea_<?php echo e($name); ?>' id="<?php echo e($name); ?>" <?php echo e($required); ?> <?php echo e($readonly); ?> <?php echo e($disabled); ?> name="<?php echo e($form['name']); ?>" class='form-control'
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/wysiwyg/component.blade.php ENDPATH**/ ?>