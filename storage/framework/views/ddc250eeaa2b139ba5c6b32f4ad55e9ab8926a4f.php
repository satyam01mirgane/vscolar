<?php $__env->startSection('content'); ?>
    ...
    <?php if($button_show_data || $button_reload_data || $button_new_data || $button_delete_data || $index_button || $columns): ?>
        <div id='box-actionmenu' class='box'>
            <div class='box-body'>
                <?php echo $__env->make("crudbooster::default.actionmenu", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if(Request::get('file') && Request::get('import')): ?>
        ...
        <ul class='nav nav-tabs'>
            <li style="background:#eeeeee"><a style="color:#111"
                                              onclick="if(confirm('Are you sure want to leave ?')) location.href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>'"
        ...
        <div id='box_main' class="box box-primary">
            ...
            <form method='post' id="form" enctype="multipart/form-data" action='<?php echo e($action); ?>'>
                ...
                <div class="box-footer">
                    <div class='pull-right'>
                        <a onclick="if(confirm('Are you sure want to leave ?')) location.href='<?php echo e(CRUDBooster::mainpath("import-data")); ?>'" href='javascript:;'
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/import.blade.php ENDPATH**/ ?>