...
<?php if($button_action_style == 'button_text'): ?>
    ...
    <?php if(CRUDBooster::isRead() && $button_detail): ?>
        <a class='btn btn-xs btn-primary btn-detail' title='<?php echo e(cbLang("action_detail_data")); ?>'
           href='<?php echo e(CRUDBooster::mainpath("detail/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())); ?>'><?php echo e(cbLang("action_detail_data")); ?></a>
    <?php endif; ?>

    <?php if(CRUDBooster::isUpdate() && $button_edit): ?>
        <a class='btn btn-xs btn-success btn-edit' title='<?php echo e(cbLang("action_edit_data")); ?>'
           href='<?php echo e(CRUDBooster::mainpath("edit/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())."&parent_id=".g("parent_id")."&parent_field=".$parent_field); ?>'><?php echo e(cbLang("action_edit_data")); ?></a>
    <?php endif; ?>

    <?php if(CRUDBooster::isDelete() && $button_delete): ?>
        <?php $url = CRUDBooster::mainpath("delete/".$row->$pk);?>
        <a class='btn btn-xs btn-warning btn-delete' title='<?php echo e(cbLang("action_delete_data")); ?>' href='javascript:;'
           onclick='<?php echo e(CRUDBooster::deleteConfirm($url)); ?>'><?php echo e(cbLang("action_delete_data")); ?></a>
    <?php endif; ?>
    ...
    <?php if(CRUDBooster::isRead() && $button_detail): ?>
        <a class='btn btn-xs btn-primary btn-detail' title='<?php echo e(cbLang("action_detail_data")); ?>'
           href='<?php echo e(CRUDBooster::mainpath("detail/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())); ?>'><i
                    class='fa fa-eye'></i> <?php echo e(cbLang("action_detail_data")); ?></a>
    <?php endif; ?>
    ...
    <?php if(CRUDBooster::isUpdate() && $button_edit): ?>
        <a class='btn btn-xs btn-success btn-edit' title='<?php echo e(cbLang("action_edit_data")); ?>'
           href='<?php echo e(CRUDBooster::mainpath("edit/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())."&parent_id=".g("parent_id")."&parent_field=".$parent_field); ?>'><i
                    class='fa fa-pencil'></i> <?php echo e(cbLang("action_edit_data")); ?></a>
    <?php endif; ?>

    <?php if(CRUDBooster::isDelete() && $button_delete): ?>
        <?php $url = CRUDBooster::mainpath("delete/".$row->$pk);?>
        <a class='btn btn-xs btn-warning btn-delete' title='<?php echo e(cbLang("action_delete_data")); ?>' href='javascript:;'
           onclick='<?php echo e(CRUDBooster::deleteConfirm($url)); ?>'><i class='fa fa-trash'></i> <?php echo e(cbLang("action_delete_data")); ?></a>
    <?php endif; ?>

<?php elseif($button_action_style == 'dropdown'): ?>

    <div class='btn-group btn-group-action'>
        <button type='button' class='btn btn-xs btn-primary btn-action'><?php echo e(cbLang("action_label")); ?></button>
        ...
        <ul class='dropdown-menu dropdown-menu-action' role='menu'>
            ...
            <?php if(CRUDBooster::isRead() && $button_detail): ?>
                <li><a class='btn-detail' title='<?php echo e(cbLang("action_detail_data")); ?>'
                       href='<?php echo e(CRUDBooster::mainpath("detail/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())); ?>'><i
                                class='fa fa-eye'></i> <?php echo e(cbLang("action_detail_data")); ?></a></li>
            <?php endif; ?>

            <?php if(CRUDBooster::isUpdate() && $button_edit): ?>
                <li><a class='btn-edit' title='<?php echo e(cbLang("action_edit_data")); ?>'
                       href='<?php echo e(CRUDBooster::mainpath("edit/".$row->$pk)."?return_url=".urlencode(Request::fullUrl())."&parent_id=".g("parent_id")."&parent_field=".$parent_field); ?>'><i
                                class='fa fa-pencil'></i> <?php echo e(cbLang("action_edit_data")); ?></a></li>
            <?php endif; ?>

            <?php if(CRUDBooster::isDelete() && $button_delete): ?>
                <?php $url = CRUDBooster::mainpath("delete/".$row->$pk);?>
                <li><a class='btn-delete' title='<?php echo e(cbLang("action_delete_data")); ?>' href='javascript:;'
                       onclick='<?php echo e(CRUDBooster::deleteConfirm($url)); ?>'><i class='fa fa-trash'></i> <?php echo e(cbLang("action_delete_data")); ?></a></li>
            <?php endif; ?>
        </ul>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/components/action.blade.php ENDPATH**/ ?>