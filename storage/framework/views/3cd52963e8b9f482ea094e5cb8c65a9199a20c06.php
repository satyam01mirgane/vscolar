        ...
        <script type="text/javascript">
            $(function () {
                $('#<?php echo e($parent); ?>, input:radio[name=<?php echo e($parent); ?>]').change(function () {
                    ...
                    if (fk_value != '') {
                        $current.html("<option value=''><?php echo e(cbLang('text_loading')); ?> <?php echo e($form['label']); ?>");
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/select/component.blade.php ENDPATH**/ ?>