...
<div class="lockscreen-wrapper">
    ...
    <div class="text-center">
        <?php echo e(cbLang("text_enter_the_password")); ?>

    </div>
    <div class='text-center'>
        <a href="<?php echo e(route("getLogout")); ?>"><?php echo e(cbLang('text_or_sign_in')); ?></a>
    </div>
    <div class='lockscreen-footer text-center'>
        Copyright &copy; <?php echo e(date("Y")); ?><br>
        All rights reserved
    </div>
</div><!-- /.center -->
...
</html><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/lockscreen.blade.php ENDPATH**/ ?>