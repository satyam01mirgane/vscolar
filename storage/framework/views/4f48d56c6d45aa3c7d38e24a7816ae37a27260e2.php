...
<?php $__env->startPush('bottom'); ?>
    ...
    <script type="text/javascript">
        var id_cms_statistics = '<?php echo e($id_cms_statistics); ?>';
        ...
        function addWidget(id_cms_statistics, area, component) {
            ...
            $.post("<?php echo e(CRUDBooster::mainpath('add-component')); ?>", {
...
<?php $__env->startPush('head'); ?>
    ...
    <style type="text/css">
        ...
        <?php if(CRUDBooster::getCurrentMethod() == 'getBuilder'): ?>
                ...
                $(".connectedSortable").sortable({
                    ...
                    update: function (event, ui) {
                        if (ui.sender) {
                            ...
                            $.post("<?php echo e(CRUDBooster::mainpath('update-area-component')); ?>", {
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.connectedSortable').each(function () {
                ...
                $.get("<?php echo e(CRUDBooster::adminpath('statistic_builder/list-component')); ?>/" + id_cms_statistics + "/" + areaname, function (response) {
                    if (response.components) {
                        ...
                        $.each(response.components, function (i, obj) {
                            ...
                            $.get("<?php echo e(CRUDBooster::adminpath('statistic_builder/view-component')); ?>/" + obj.componentID, function (view) {
            ...
            $(document).on('click', '.btn-delete-component', function () {
                ...
                swal({
                    ...
                    function () {
                        ...
                        $.get("<?php echo e(CRUDBooster::mainpath('delete-component')); ?>/" + componentID, function () {
            ...
            $(document).on('click', '.btn-edit-component', function () {
                ...
                $.get("<?php echo e(CRUDBooster::mainpath('edit-component')); ?>/" + componentID, function (response) {
            ...
            $('#modal-statistic .btn-submit').click(function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "<?php echo e(CRUDBooster::mainpath('save-component')); ?>",
                    success: function () {

                        $button.removeClass('disabled').text('Save Changes');
                        $('#modal-statistic').modal('hide');
                        window.location.href = "<?php echo e(Request::fullUrl()); ?>";
                    },
                    error: function () {
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/statistic_builder/index.blade.php ENDPATH**/ ?>