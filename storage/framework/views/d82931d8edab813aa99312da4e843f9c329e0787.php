...
<section id="page-title" data-bg-parallax="<?php echo e(asset('assets/images/workshop.png')); ?>">
            <div class="container">
                <div class="page-title" style="min-height:150px;">
                    <!--<h1><?php echo e($workshop_details->name); ?></h1>-->
...
<!-- CONTENT -->        
                            ...
                            <div class="post-item">
                                <div class="row">
                                    ...
                                    <div class="post-image">
                                        <a href="#">
                                        <img alt="" src="<?php echo e(asset($workshop_details->image)); ?>"></a>
                                    </div>
                                    </div>
                                    <div class="col-md-7">
                                    <div class="post-item-description pt-0">
                                        <h2><a href="workshops-detail.php"><?php echo e($workshop_details->name); ?></a></h2>
                                        <p><?php echo preg_replace($pattern, '', str_replace('Tahoma','',$workshop_details->short_description));?></p>
                                        <ul class="list_will_get">
											<?php if($workshop_details->trainer_name): ?>
                                            <li><i class="fa fa-user"></i> <?php echo e($workshop_details->trainer_name); ?></li>
											<?php endif; ?>
                                            <li><i class="fa fa-calendar-check-o"></i> <?php echo e(date('d M, Y',strtotime($workshop_details->session_date))); ?></li>   
											<li><i class="fa fa-clock"></i> <?php echo e($workshop_details->session_time); ?></li>
                                        </ul>                                       
                                    </div>
                                    </div>
                                    
                                    <div class="d-flex justify-content-end">
										<?php if($workshop_details->total_seat > 0): ?>
											<button type="button" class="btn btn-outline;" style="margin-right:5px;"><?php echo e($workshop_details->total_seat); ?> SEAT LEFT </button>
										<?php else: ?>
											<button type="button" class="btn btn-outline;">SEAT FULL </button>	
										<?php endif; ?>
										<?php if(!in_array($workshop_details->id,cartproduct())): ?>
											<?php if($workshop_details->total_seat > 0): ?>
												<form action="<?php echo e(route('cart.store')); ?>" method="POST" enctype="multipart/form-data">
													<?php echo csrf_field(); ?>
													<input type="hidden" value="<?php echo e($workshop_details->id); ?>" name="id">
													<input type="hidden" value="<?php echo e($workshop_details->name); ?>-Workshop" name="name">
													<input type="hidden" value="<?php echo e($workshop_details->price); ?>" name="price">
													<input type="hidden" value="<?php echo e($workshop_details->image); ?>"  name="image">
													<input type="hidden" value="1" name="quantity">
													<button class="btn btn-outline;" type="submit">Enroll Now </button>
												</form>
											<?php endif; ?>
										<?php else: ?>
											<a href="<?php echo e(url('cart')); ?>"><button class="btn btn-outline disabled" type="button">In Cart</button></a>
										<?php endif; ?>
                                        <button type="button" class="btn btn-outline; " style="margin-left:5px;">₹<?php echo e($workshop_details->price); ?> </button>
                                    </div>
                                </div>
                            </div>
                        </div>
		...
		<section id="page-content" class="background-grey no-padding">
            ...
            <h3>Sample Certificate</h3>                 
                ...
                <div class="content col-lg-6">
                <img alt="" src="<?php echo e(asset($workshop_details->sample_certificate_image)); ?>" class="rounded-3 w-100">
                </div>         
            </div>
            <!-- Part 2 -->
            <div class="row">
                ...
                <!--start Accordion  -->
						<div class="accordion fancy radius clean">
                             <div class="ac-item ac-active">
                                 <h5 class="ac-title"><i class="fa fa-arrow-right"></i><?php echo e($workshop_details->question1); ?></h5>
                                 <div class="ac-content ac-active"><?php echo e($workshop_details->answer1); ?></div>
                             </div>
                         </div>
						 <div class="accordion fancy radius clean">
                             <div class="ac-item">
                                 <h5 class="ac-title"><i class="fa fa-arrow-right"></i><?php echo e($workshop_details->question2); ?></h5>
                                 <div class="ac-content ac-active"><?php echo e($workshop_details->answer2); ?></div>
                             </div>
                         </div>
						 <div class="accordion fancy radius clean">
                             <div class="ac-item">
                                 <h5 class="ac-title"><i class="fa fa-arrow-right"></i><?php echo e($workshop_details->question3); ?></h5>
                                 <div class="ac-content ac-active"><?php echo e($workshop_details->answer3); ?></div>
                             </div>
                         </div>
						 <div class="accordion fancy radius clean">
                             <div class="ac-item">
                                 <h5 class="ac-title"><i class="fa fa-arrow-right"></i><?php echo e($workshop_details->question4); ?></h5>
                                 <div class="ac-content ac-active"><?php echo e($workshop_details->answer4); ?></div>
                             </div>
                         </div>
						 <div class="accordion fancy radius clean">
                             <div class="ac-item">
                                 <h5 class="ac-title"><i class="fa fa-arrow-right"></i><?php echo e($workshop_details->question5); ?></h5>
                                 <div class="ac-content ac-active"><?php echo e($workshop_details->answer5); ?></div>
                             </div>
                         </div>
                                   <!--end: Accordion  -->
                </div>
...
<?php echo $__env->make('front.common.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/pages/workshop-details.blade.php ENDPATH**/ ?>