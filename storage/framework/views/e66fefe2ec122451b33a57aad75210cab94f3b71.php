...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <p class='login-box-msg'><?php echo e(cbLang("login_message")); ?></p>
        <form autocomplete='off' action="<?php echo e(route('postLogin')); ?>" method="post">
            ...
            <div class='row'>
                <div class='col-xs-12' align="center"><p style="padding:10px 0px 10px 0px"><?php echo e(cbLang("text_forgot_password")); ?> <a
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/login.blade.php ENDPATH**/ ?>