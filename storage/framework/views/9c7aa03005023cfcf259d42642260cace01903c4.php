                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-9 col-sm-3"><?php echo e($orders->product_name); ?></div>
                            <div class="d-none d-sm-block col-2">1</div>
                            <div class="d-none d-sm-block col-2 text-95">₹<?php echo e($orders->product_price); ?></div>
                            <div class="d-none d-sm-block col-2 text-95">₹<?php echo e($orders->product_discount); ?></div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-120 text-secondary-d1">₹<?php echo e($orders->product_price - $orders->product_discount); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    <span class="text-150 text-success-d3 opacity-2">₹<?php echo e($orders->product_price - $orders->product_discount); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/resources/views/front/pages/course-invoice.blade.php ENDPATH**/ ?>