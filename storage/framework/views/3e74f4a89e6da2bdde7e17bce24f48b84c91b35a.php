<div class='form-group <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>' style="<?php echo e(@$form['style']); ?>">
    ...
    <div class="<?php echo e($col_width?:'col-sm-10'); ?>">
        <div class="input-group">
            ...
            <input type="email" name="<?php echo e($name); ?>" style="display: none">
            <input type='email' title="<?php echo e($form['label']); ?>"
...
</div><?php /**PATH /home/u104865507/domains/ VIEF SCHOLAR .in/public_html/vendor/crocodicstudio/crudbooster/src/views/default/type_components/email/component.blade.php ENDPATH**/ ?>