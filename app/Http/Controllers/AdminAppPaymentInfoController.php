<?php namespace App\Http\Controllers;
	...
	class AdminAppPaymentInfoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "app_payment_info";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Name","name"=>"user_id","join"=>"users,name"];
			$this->col[] = ["label"=>"Order No","name"=>"order_id"];
			$this->col[] = ["label"=>"Email","name"=>"user_id","join"=>"users,email"];
			$this->col[] = ["label"=>"Phone","name"=>"user_id","join"=>"users,phone_number"];
		...
		$this->form[] = ["label"=>"Payment Status","name"=>"payment_status","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		...
		$this->form[] = ["label"=>"Payment Update Date","name"=>"payment_update_date","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
		$this->form[] = ["label"=>"Payment Amount","name"=>"payment_amount","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
