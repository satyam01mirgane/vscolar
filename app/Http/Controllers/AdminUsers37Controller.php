<?php namespace App\Http\Controllers;
	...
	class AdminUsers37Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"User Since","name"=>"created_at"];
			...
			//$this->form[] = ["label"=>"Coursetype","name"=>"coursetype","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
