<?php namespace App\Http\Controllers;
	...
	class AdminAppQuizCategoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
			$get_data = DB::table('app_quiz_category')->where('id',$id)->first();
			$slug = cleanString($get_data->name);
			DB::table('app_quiz_category')->where('id',$id)->update(['slug'=>$slug]);
	    }
