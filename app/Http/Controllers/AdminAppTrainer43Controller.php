<?php namespace App\Http\Controllers;
	...
	class AdminAppTrainer43Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_after_add($id) {        
	        $get_data = DB::table('app_trainer')->where('id',$id)->first();
			$slug = cleanString($get_data->name);
			DB::table('app_trainer')->where('id',$id)->update(['slug'=>$slug]);
