<?php namespace App\Http\Controllers;
	...
	class AdminAppTestCategoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
			$get_data = DB::table('app_test_category')->where('id',$id)->first();
			$slug = cleanString($get_data->name);
			DB::table('app_test_category')->where('id',$id)->update(['slug'=>$slug]);
	    }
