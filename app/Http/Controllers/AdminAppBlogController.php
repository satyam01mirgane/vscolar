<?php namespace App\Http\Controllers;
	...
	class AdminAppblogController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Category","name"=>"category_id","join"=>"app_category,name"];
			$this->col[] = ["label"=>"Created At","name"=>"created_at"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'app_category,name'];
	    ...
	    */
	    public function hook_after_add($id) {        
	        $get_data = DB::table('app_blog')->where('id',$id)->first();
			$slug = cleanString($get_data->name);
			DB::table('app_blog')->where('id',$id)->update(['slug'=>$slug]);
